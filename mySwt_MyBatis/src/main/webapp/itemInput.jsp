...
<table>
<tr><th>상품 번호</th><td><input type="text" name="CODE"
	id="code"/><input type="button" value="중복 검사"
	onClick="codeCheck()"/></td></tr>
<tr><th>상품 이름</th><td><input type="text" name="NAME"/>
	</td></tr>
<tr><th>상품 가격</th><td><input type="text" name="PRICE"/>
	</td></tr>
<tr><th>상품 정보</th><td><textarea rows="4" cols="50"
